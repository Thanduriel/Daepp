...
FUNC VOID Print 				( VAR STRING s0 ) 0x006E2BA0;
// Ausgabebefehl, der Text ins Game schreibt (wie OutputunitTexte)
FUNC VOID PrintMulti 			( VAR STRING s0, VAR STRING s1, VAR STRING s2, VAR STRING s3, VAR STRING s4 ) 0x006E3BD0;
// Printbefehl, der aus den angegebenen Strings einen Auswählt und auf den Bildschirm schreibt
FUNC VOID PrintDebug			(VAR STRING s)	0x006E2CA0;
// Printausgabe, die nur bei eingeschaltetem Debugmodus (Alt+D) im Spy/logfile ausgegeben wird
func VOID PrintScreen           (var INT dialogNr, VAR STRING msg, VAR INT posx, VAR INT posy, VAR STRING font, VAR INT timeSec) 0x006E2DA0;
...
//added
func void AI_PrintScreen (var INT dialogNr, VAR STRING msg, VAR INT posx, VAR INT posy, VAR STRING font, VAR INT timeSec) 0x006E3070;
func void PrintDialog() 0x006E3460;
...
func void	ExitGame			() 0x006FB930;

								// Beendet Gothic.

func void	ExitSession			() 0x006FB950;

								// Beendet das laufende Spiel.

func int	PlayVideo			(var string Filename) 0x006D45B0;
...
func int	PlayVideoEx			(var string Filename, var int ScreenBlend, var int ExitSession) 0x006D4690;
...
func void	SetPercentDone		(var int PercentDone) 0x006FB970;

								// Setz die Fortschrittsanzeige im Ladebalken.
								//
								//	PercentDone	- Aktueller Fortschritt des Ladevorgangs in Prozent (0-100)

func void	IntroduceChapter	(var string Titel, var string Untertitel, var string Texture, var string Sound, var int WaitTime) 0x006FB4E0;
...
FUNC VOID	Npc_MemoryEntry				(VAR C_NPC self, VAR INT source, VAR C_NPC offender, VAR INT newsid, VAR C_NPC victim) 0x006DAE80;
...
FUNC VOID	Npc_MemoryEntryGuild		(VAR C_NPC self, VAR INT source, VAR C_NPC offender, VAR INT newsid, VAR C_NPC victimguild) 0x006DB900;
// wie MemoryEntry nur, das die Memory für die ganze Gilde kreiert wird
FUNC INT    Npc_HasNews					(VAR C_NPC self, VAR INT newsID, VAR C_NPC offender, VAR C_NPC victim) 0x006F3A90;
...
FUNC INT    Npc_IsNewsGossip			(VAR C_NPC self, VAR INT newsNumber) 0x006F4740;
// Liefert >0, falls News "Gossip" ist
FUNC C_NPC  Npc_GetNewsWitness			(VAR C_NPC self, VAR INT newsNumber) 0x006F3D20;
// Ermittle Zeuge der News und gibt eine INstanz der Klasse C_Npc zurück
FUNC C_NPC  Npc_GetNewsVictim			(VAR C_NPC self, VAR INT newsNumber) 0x006F43E0;
// Ermittle Opfer der News und gibt eine INstanz der Klasse C_Npc zurück
FUNC C_NPC 	Npc_GetNewsOffender 		(VAR C_NPC self, VAR INT newsNumber ) 0x006F4080;
// Ermittelt Täter der News und gibt eine INstanz der Klasse C_Npc zurück

//added
func void Npc_DeleteNews(VAR C_NPC self, VAR INT newsNumber) 0x006F4AA0;
...
FUNC INT	Wld_DetectPlayer			(VAR C_NPC self) 0x006E1010;
...
FUNC INT 	Npc_GetGuildAttitude 		(VAR C_NPC npc, VAR C_NPC npc ) 0x006E5C00;
...
//added
func int NpcGetActiveSpellIsScroll(VAR C_NPC self) 0x006E5B20;
...
FUNC INT   	Wld_DetectNpc   			(VAR C_NPC self, VAR INT instance, VAR func aiState, VAR INT guild) 0x006E11D0;
...
VAR INT 	Wld_DetectNpcEx ( VAR C_NPC self, VAR INT npcInstance, VAR FUNC aiState, VAR INT guild, VAR INT detectPlayer) 0x006E15C0;
// Wie Wld_DetectNpc(). Zusätzlich kann per detectPlayer=0 der Spieler ignoriert werden.
FUNC INT 	Wld_DetectItem				(VAR C_NPC self, VAR INT flags) 0x006E0E40;
...
//added
func int Wld_DetectNpcExAtt( VAR C_NPC self, VAR INT npcInstance, VAR FUNC aiState, VAR INT guild, VAR INT detectPlayer, var int atr) 0x006E19C0;
...
// *******************************************************************************************
func string	IntToString			( var int x) 0x006E2730;
// !!!Funktion überträgt eine Integer variable in eine Stringvariable (Rückgabewert : string)???

func int	FloatToInt			( var float x) 0x006E29E0;
...
func string FloatToString (var float x) 0x006E2870;
func float	IntToFloat			( var int x) 0x006E29B0;
// !!! wie float to int, nur daß ein integer in float umgewandelt wird ???
func string ConcatStrings		(var string str1, var string str2) 0x006E2A10;
